...
namespace Base
{
    ...
    public:
        ...
        virtual void callback_verify(tars::Int32 ret, Base::VerifyRsp&&  rsp)
        { callback_verify(ret, rsp); }
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__Verify_all, __Verify_all+1, (it==_msg_->response->status.end())?_msg_->request.sFuncName:it->second);
            ...
            switch(r.first - __Verify_all)
            {
                case 0:
                {
                    ...
                    {
                        callback_verify_exception(_msg_->response->iRet);
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, "", getModuleName(), "verify", 0, _trace_param_, "");
                    }
                    ...
                    callback_verify(_ret, std::move(rsp));
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__Verify_all, __Verify_all+1, string(_msg_->request.sFuncName));
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __Verify_all)
            {
                case 0:
    ...
    public:
        ...
        tars::Int32 verify(const Base::VerifyReq & req,Base::VerifyRsp &rsp,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CS), TRACE_ANNOTATION_CS, tars_moduleName(), tars_name(), "verify", 0, _trace_param_, "");
            }
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, tars_moduleName(), tars_name(), "verify", 0, _trace_param_, "");
            }
        ...
        VerifyProxy* tars_hash(size_t key)
        {
            return (VerifyProxy*)ServantProxy::tars_hash(key);
        }

        VerifyProxy* tars_consistent_hash(size_t key)
        {
    ...
    public:
        virtual ~Verify(){}
        virtual tars::Int32 verify(const Base::VerifyReq & req,Base::VerifyRsp &rsp,tars::TarsCurrentPtr _current_) = 0;
        virtual tars::Int32 verify(Base::VerifyReq && req,Base::VerifyRsp &rsp,tars::TarsCurrentPtr _current_) 
        { return verify(req, rsp, _current_); }
        static void async_response_verify(tars::TarsCurrentPtr _current_, tars::Int32 _ret, const Base::VerifyRsp &rsp)
        {
            size_t _rsp_len_ = 0;
            ...
            if (_current_->isTraced())
            {
                ...
                {
                    TARS_TRACE(_current_->getTraceKey(), TRACE_ANNOTATION_SS, "", _current_->getModuleName(), "verify", 0, _trace_param_, "");
                }
            }

        }
        static void async_response_push_verify(tars::CurrentPtr _current_, tars::Int32 _ret, const Base::VerifyRsp &rsp, const map<string, string> &_context = tars::Current::TARS_STATUS())
        {
            {
                tars::TarsOutputStream<tars::BufferWriterVector> _os;
                _os.write(_ret, 0);
                ...
                _current_->sendPushResponse( tars::TARSSERVERSUCCESS ,"verify", _os, _context);
            }
        }
            ...
            switch(r.first - __Base__Verify_all)
            {
                case 0:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SR), TRACE_ANNOTATION_SR, "", getModuleName(), "verify", 0, _trace_param_, "");
                    }

                    tars::Int32 _ret = verify(std::move(req),rsp, _current);
                    if(_current->isResponse())
                    {
                        ...
                        if (_pSptd_ && _pSptd_->_traceCall)
                        {
                            ...
                            TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SS), TRACE_ANNOTATION_SS, "", getModuleName(), "verify", 0, _trace_param_, "");
                        }
